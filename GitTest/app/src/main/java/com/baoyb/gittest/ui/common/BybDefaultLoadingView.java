 ...
 */
public class BybDefaultLoadingView extends RelativeLayout {
    ...
    public BybDefaultLoadingView(Context context) {
        this(context, null);
    }

    public BybDefaultLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BybDefaultLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.layout_error_view);
        loadingViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.byb_defaule_loading);
